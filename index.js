...
function addScore() {
    ...
    console.log("addScore rank", rank); 
...
function showHighScores() {
    ...
    while(i<hScores.length ) {
        console.log("hScores[i].rank: ", hScores[i].rank);
        ...
        let resultRank = document.createElement('td');
        ...
        resultsRow.appendChild(resultRank);
        resultsRow.appendChild(resultScore);
        resultsRow.appendChild(resultInitials);
